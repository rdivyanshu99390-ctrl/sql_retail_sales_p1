...
-- Q.3 wirte a SQL query to calculate the total slaes (total_sales) for each category.
...
-- Q.4 Write a SQL quert to find the average age of customers who purchased items from the 'Beauty' category.
...
--Q.8 write a sql query to fing the top 5 customers based on the highest total sales
...
-- Show current time of system SELECT EXTRACT (HOUR FROM CURRENT_TIME)
